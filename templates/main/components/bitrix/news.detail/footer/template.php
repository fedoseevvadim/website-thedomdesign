...
?>
		...
		<div class="left_bar">
			<div class="social_net_panel_footer">
				...
				<a href="<?=$arResult['PROPERTIES']['fb_link']['VALUE']?>" target="_blank"><i class="fa fa-facebook"></i></a>
                <? } ?>
                <? if ($arResult["DISPLAY_PROPERTIES"]['inst_link']){?>
				<a href="<?=$arResult['PROPERTIES']['inst_link']['VALUE']?>" target="_blank"><i class="fa fa-instagram"></i></a>
                <? } ?>
                <? if ($arResult["DISPLAY_PROPERTIES"]['tw_link']){?>
				<a href="<?=$arResult['PROPERTIES']['tw_link']['VALUE']?>" target="_blank"><i class="fa fa-twitter"></i></a>
                <? } ?>	
			</div>
